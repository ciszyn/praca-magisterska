...
czego przykładem jest obliczanie energi promieniowania w sposób uproszczony
...
maszynowego. Poniważ prognozowanie danych nieodłącznie jest związanie z szeregami czasowymi,
zastosowanie walidacji krzyżowej jest kłopotliwe. Zamiast kroswalidacji zastosowana 
zasosowanya została walidacja n-fold forward chaining, w którym zbiór testowy składa się 
z danych należących do okresu bezpośrednio następującego po zbiorze treningowym. Ta metoda
przynosi o wiele dokładaniejsze wyniki, ponieważ skupia się na przewidywaniu danych 
...
wprzód, bezpośrednia ekstrapolacja predykcji z obserwacji jest bardziej dokładna niż 
...
sformuowaniem ewolucji systemu zależnego czasowo i pozostałymi stopniami swobody aby 
przystosować się do zmienności danych\cite{can-dl-beat-numerical}. Dla przykładu 
model korzystający z godzinnych odczytów temperatury zazwyczaj powinien zawierać conajmniej
...
bardzo istatna w przeprowadzeniu dalszych badań.
